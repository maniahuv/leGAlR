...
RELATION_QUERY_KEYWORDS = [
    "sửa đổi", "bổ sung", "thay thế", "bãi bỏ", "hủy bỏ", "hết hiệu lực", "còn hiệu lực",
    "ngưng hiệu lực", "tham chiếu", "dẫn chiếu", "liên quan", "văn bản nào", "quy định chi tiết",
    "hướng dẫn thi hành", "hướng dẫn", "thay cho", "được sửa đổi bởi", "bị thay thế bởi",
]
